...
tests = [ {'description': 'PINA: 0x04 => PORTB: 0, state: wait',
    'steps': [{'inputs': [('PINA', 0x04)], 'iterations': 1}],
    'expected': [('PORTB',0x00)],
    },
	{'description': 'PINA: 0x01 => PORTB: 0, state: SMStart',
    'steps': [{'inputs': [('PINA', 0x03)], 'iterations': 1}],
    'expected': [('PORTB',0x00)],
    },

	{'description': 'Unlock door: 0x01 => PORTC: 0x09',
        'steps': [
	...
	{'description': 'PINA: 0x80 => PORTB: 0, state: SMStart',
